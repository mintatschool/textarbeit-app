...
import { AdjectiveDefinition } from '../types';

// Format: [Positiv, Komparativ, Superlativ]
// Superlativ meist in der Form "am ..."
export const RAW_ADJ_DB: [string, string, string][] = [
  // --- A ---
...
let REVERSE_ADJ_INDEX: Map<string, AdjectiveDefinition> | null = null;
...
export const analyzeTextLocalAdjectives = (text: string): AdjectiveDefinition[] => {
    buildAdjIndex();
    const found: AdjectiveDefinition[] = [];
