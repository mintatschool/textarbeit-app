            ...
            <div className="bg-white px-6 py-4 shadow-sm flex flex-col md:flex-row gap-4 justify-between items-center z-10 shrink-0">
                <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-start">
                    ...
                    <div className="flex items-center gap-4">
                        {isGameMode && <div className="flex items-center gap-2 bg-slate-100 px-3 py-1 rounded-lg border border-slate-200 font-mono text-lg font-bold text-blue-600"><Icons.Clock size={20} /> {timer}s</div>}
